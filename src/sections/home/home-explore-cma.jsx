...
const posts = [
  {
    ...
    title: 'What is CMA?',
    content:
      'The Certified Management Accountant (CMA) is a professional certification in financial management and accounting.',
  },
  {
    id: 2,
    title: 'CMA vs. CPA',
    content:
      'The Certified Public Accountant (CPA) and Certified Management Accountant (CMA) are both professional certifications in accounting, but they have different focuses and requirements.',
  },
  {
    id: 3,
    title: 'CMA Exam Format',
    content:
      'The CMA exam consists of two parts, each with 100 multiple-choice questions and two 30-minute essay questions.',
  },
  {
    id: 4,
    title: 'CMA Exam Questions',
    content:
      "The CMA exam questions are designed to test a candidate's knowledge and skills in financial management, accounting, and other related areas.",
  ...
  },
  {
    ...
    content:
      "The CMA certification requires a bachelor's degree from an accredited institution and two years of experience in financial management or accounting.",
                  ...
                  <CardContent>
                    <Typography
                      ...
                      sx={{
                        fontWeight: 'bold',
                        mb: 2,
                        color: theme.palette.mode === 'dark' ? 'common.white' : '#34495e',
                      }}
                    >
                      {post.title}
                    </Typography>
