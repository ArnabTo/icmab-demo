...
const QUOTES = [
  ...
  },
  {
    ...
    author: 'Fatima Ahmed',
    avatar: '/assets/images/mock/avatar/avatar-2.webp',
  ...
  },
  {
    ...
    author: 'Abdul Karim',
    avatar: '/assets/images/mock/avatar/avatar-3.webp',
  ...
  },
  {
    ...
    author: 'Nusrat Jahan',
    avatar: '/assets/images/mock/avatar/avatar-4.webp',
...
function CarouselItem({ item, selected }) {
  ...
  return (
    ...
    >
      ...
      >
        <SectionTitle title="Quotes" sx={{ mb: { xs: 3 }, textAlign: { xs: 'center' } }} />
        <Stack direction="row" spacing={1}>
          ...
          >
            <Iconify
              ...
              width={45}
              sx={{ color: 'primary.main', opacity: 0.35 }}
            />
            "{item.text}"
          </Typography>
        </Stack>
